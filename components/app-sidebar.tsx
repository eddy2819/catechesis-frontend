...
const navigationByRole = {
  admin: [
    ...
    { name: "Grupos", href: "/dashboard/grupos", icon: UserRoundCog },
    { name: "Estudiantes", href: "/dashboard/students", icon: Users },
    {
      name: "Gestión Parroquial",
      href: "/dashboard/parish-management",
      icon: Building2,
    },
    { name: "Familias", href: "/dashboard/families", icon: UsersRound },
    { name: "Monaguillos", href: "/dashboard/altar-servers", icon: Cross },
